        ...
        <div className="max-w-md w-full mx-auto px-6 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              <span className="font-medium text-foreground">{form.companyName}</span> has been added
              to the platform.
            </p>
          </div>
      ...
      <div className="border-b bg-background px-6 py-4 flex-shrink-0">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Add a new tenant organization to the platform</p>
          </div>
          <button
            type="button"
            onClick={onClose}
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Basic information about the customer organization.</p>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="companyName">Business Name <span className="text-destructive">*</span></Label>
                  <Input
                    id="companyName"
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Connect to the customer's Amazon Connect instance.</p>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="connectInstanceId">Amazon Connect Instance ID <span className="text-destructive">*</span></Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="numberOfAgents">No. of Agents <span className="text-destructive">*</span></Label>
                  <Input
                    id="numberOfAgents"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="region">Region (Amazon Connect) <span className="text-destructive">*</span></Label>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Configure the AI coaching capabilities for this customer.</p>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-3">
                  <Label>AI Coaching tier <span className="text-destructive">*</span></Label>
                  <div className="space-y-2">
                    <RadioCard
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Automatically trigger coaching from Amazon Connect evaluation results.</p>
              </div>
              ...
              {form.evalCoachingEnabled && (
                <div className="space-y-5">
                  ...
                  {/* Threshold slider — only when below_threshold selected */}
                  ...
                  <div className="flex gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
                    ...
                    <p>
                      TrAIna will automatically read the evaluation form structure — section names, questions, and score
                      scales — from the data. No manual mapping needed. Coaching topics will use the evaluation section
                      names as they appear in Connect.
                    </p>
                  </div>
                </div>
              )}
          ...
          {step === 5 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Check everything looks right before creating the customer.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg overflow-hidden">
                  <div className="bg-muted/40 px-4 py-2.5 border-b flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Business details</span>
                  </div>
                ...
                <div className="border rounded-lg overflow-hidden">
                  <div className="bg-muted/40 px-4 py-2.5 border-b flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Amazon Connect</span>
                  </div>
                  <div className="divide-y">
                ...
                <div className="border rounded-lg overflow-hidden">
                  <div className="bg-muted/40 px-4 py-2.5 border-b flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">AI configuration</span>
                  </div>
                  <div className="divide-y">
                    <ReviewRow label="LLM API Key" value={form.llmApiKey ? "••••••••••••••••" : "Not set"} />
                    <ReviewRow label="AI Coaching tier" value={<span className="capitalize font-medium">{form.aiCoachingTier}</span>} />
                  </div>
                </div>
                ...
                <div className="border rounded-lg overflow-hidden">
                  <div className="bg-muted/40 px-4 py-2.5 border-b flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Evaluation coaching</span>
                  </div>
                  {form.evalCoachingEnabled ? (
                    <div className="divide-y">
                      <ReviewRow
