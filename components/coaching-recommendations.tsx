...
const agentPlansData: AgentPlan[] = [
  ...
  },
  {
    ...
    agentName: "Sarah Chen",
    agentAvatar: "SC",
    patternName: "Empathy Deficit in Billing",
    ...
    status: "active",
    source: "evaluation",
    evaluationContext: { criterionName: "Empathy & Tone", score: 5, maxScore: 10, contactCount: 14 },
    supervisorNote:
      "Sarah — your quality evaluation scores flagged Empathy & Tone as a gap across 14 recent billing contacts. This plan will help you build consistent empathy habits before moving into resolution mode. You're close to where we need you to be.",
    sections: [
    ...
    timeline: [
      { event: "Evaluation flagged low Empathy & Tone score (50%) across 14 contacts", date: "3 days ago", type: "assigned" },
      { event: "Plan auto-generated from Billing & Refunds Quality Scorecard", date: "2 days ago", type: "assigned" },
      { event: "Plan assigned by Team Lead", date: "2 days ago", type: "assigned" },
    ],
  },
  {
